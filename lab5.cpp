...
cin >> monthinput;
studentinfo[i].monthstring = studentinfo[i].birthmonthstring[monthinput - 1];
...
studentinfo[i].cakeday = studentinfo[i].monthstring + "/" + studentinfo[i].day + "/" + studentinfo[i].year;
